...
(async()=>{
 ...
 await page.click('#add-game');await page.selectOption('#f-team','tigers');await page.fill('#f-date','2026-05-01');await page.click('#f-api-fetch');await page.waitForFunction(()=>document.getElementById('f-api-status').textContent==='取得しました');check('away score uses team ID',await page.inputValue('#f-bay-score')==='5');await page.click('#f-cancel');
