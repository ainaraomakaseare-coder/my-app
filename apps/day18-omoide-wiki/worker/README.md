...
- **Google AI Studioの無料枠では足りません。** 無料枠は1分あたりの回数がとても少なく、アプリは「今の質問を読んでいる間に次の質問の声を先に作る」ため、2問目から上限で断られて標準の声に戻ってしまいます（2026-09-24に実際に発生）。AI Studioで課金（有料プラン）を有効にして使ってください。上限に当たったときは、インタビュー画面に「Geminiの利用回数の上限に達しました」と理由が出ます
