...
<!--
このSkillは addyosmani/agent-skills（MITライセンス）の documentation-and-adrs を元にしています。
取り込み元: https://github.com/addyosmani/agent-skills/blob/main/skills/documentation-and-adrs/SKILL.md
